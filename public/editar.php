...
if (isset($_GET['codigo'])) {
  ...
  if ($derechohabiente) {
    ...
    // Si no lo encuentra, aviso y redirijo a natural.php
    echo "<script>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    ...
    if ($stmt->execute()) {
      // Indicamos que, al recargar, se debe mostrar SweetAlert de éxito
      $show_alert = true;
    } else {
...
<body>
    ...
    <div class="content">
      <div class="form-container">
        ...
        <form id="form-derecho" method="POST" action="">
          ...
          <div class="buttons">
            <!-- El botón Cancelar redirige a natural.php -->
  ...
  <?php if ($show_alert): ?>
    <!-- SweetAlert2 para anunciar el éxito y luego redirigir a natural.php -->
    <script>
      Swal.fire({
        icon: 'success',
        title: '<?= $mensaje_exito ?>',
