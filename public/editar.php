...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;font-family:Arial,sans-serif;}
    ...
    .sidebar img.logo{
      width:120px;margin:0 auto 20px auto;border-radius:10px;
    }
    .sidebar h3{
    ...
    .submenu a{
      ...
      padding:8px;background:rgba(255,255,255,0.2);
    ...
    .content{
      ...
      margin:0 20px;padding:20px;border-radius:10px;
      overflow-y:auto;
    }
    .form-container{
        ...
        <form method="POST" action="">
          ...
          <div class="form-group">
            ...
            <select id="tipo_derecho" name="tipo_derecho" required>
              <option value="natural" <?= $derechohabiente['tipo_derechohabiente']=='natural'? 'selected':'' ?>>
                Natural
              </option>
              <option value="juridica" <?= $derechohabiente['tipo_derechohabiente']=='juridica'? 'selected':'' ?>>
                Jurídica
              </option>
            </select>
          </div>
