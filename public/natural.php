...
<head>
  ...
  <title>Lista Natural – Sistema de Cobro</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="content">
      <h2>Lista de Derechohabiente: Natural</h2>
      ...
      <table>
        <thead>
          <tr>
            ...
            <th>Dirección</th><th>Teléfono</th><th>Tipo</th><th>Estado</th><th>Acciones</th>
          </tr>
        </thead>
          ...
          <tr>
            ...
            <td>
              ...
              <?php if ($rol_usuario==='Administrador'): ?>
                ...
                <button class="action-btn btn-delete" onclick="confirmarEliminacion(<?= $row['codigo'] ?>)">
  ...
  <script>
    ...
    function eliminarDerechohabiente(){
      ...
      form.method = 'POST';
      form.innerHTML = `<input type="hidden" name="eliminar_id" value="${idEliminar}">`;
